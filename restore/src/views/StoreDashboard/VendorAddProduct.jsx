                ...
                <form>
                    ...
                    <div className="file-drop-area mb-3">
                        ...
                        <input className="file-drop-input" type="file"/>
                            <button className="file-drop-btn btn btn-primary btn-sm mb-2" type="button">Or select file
                            </button>
                    ...
                    <div className="mb-3 py-2">
                        ...
                        <div className="bg-secondary p-3 fs-ms rounded-bottom"><span
                            className="d-inline-block fw-medium me-2 my-1">Markdown supported:</span><em
                            className="d-inline-block border-end pe-2 me-2 my-1">*Italic*</em><strong
                            className="d-inline-block border-end pe-2 me-2 my-1">**Bold**</strong><span
                            className="d-inline-block border-end pe-2 me-2 my-1">- List item</span><span
                            className="d-inline-block border-end pe-2 me-2 my-1">##Heading##</span><span
                            className="d-inline-block">--- Horizontal rule</span></div>
                    </div>
                    <div className="row">
                    ...
                    <div className="mb-3 py-2">
                        ...
                        <div className="form-text">Up to 10 keywords that describe your item. Tags should all be in
                    ...
                    <button className="btn btn-primary d-block w-100" type="submit"><i
                        className="ci-cloud-upload fs-lg me-2"></i>Upload Product
                    </button>
                </form>
            </div>
        </section>
