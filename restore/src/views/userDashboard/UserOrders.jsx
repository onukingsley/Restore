                    ...
                    <section className="col-lg-8">
                        ...
                        <div className="d-flex justify-content-between align-items-center pt-lg-2 pb-4 pb-lg-5 mb-lg-3">
                            <div className="d-flex align-items-center">
                                <label className="d-none d-lg-block fs-sm text-light text-nowrap opacity-75 me-2" for="order-sort">Sort orders:</label>
                                <label className="d-lg-none fs-sm text-nowrap opacity-75 me-2" For="order-sort">Sort orders:</label>
                        ...
                        <div className="table-responsive fs-md mb-4">
                            <table className="table table-hover mb-0">
                                ...
                                {order && Object.keys(order).map((key,index)=>{
                                    ...
                                    return  <tr>
                                        <OrderModal props={{key:key,property:order[key]}}/>
                                        <td className="py-3"><a className="nav-link-style fw-medium fs-sm" data-bs-target={`#order-details${key}`} data-bs-toggle="modal">{key}</a></td>
                                        <td className="py-3">May 21, 2019</td>
                                        <td className="py-3"><span className="badge bg-info m-0">In Progress</span></td>
                                        <td className="py-3">${order[key][0]['total']}</td>
                                    </tr>
                                })}
